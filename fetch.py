#!/usr/bin/env python3
"""
Recuperation des codes promo Espace Plaisir depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/espaceplaisir.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/espaceplaisir.fr"
STORE_NAME = "Espace Plaisir"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Espace Plaisir depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-espaceplaisir)"
    }
    try:
